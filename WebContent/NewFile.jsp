...
<%
    ...
    try {
        String DB_HOST = "jdbc:oracle:thin:@localhost:1523:orcll"; // 아이피, 포트, 서비스(SID) 정보를 수정
        String DB_USER = "hr"; // 아이디(유저) - 11g 이상시 대소문자 구분 확인
        String DB_PASS = "12341234"; // 패스워 - 11g 이상시 대소문자 구분 확인
